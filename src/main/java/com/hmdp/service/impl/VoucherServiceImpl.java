...
public class VoucherServiceImpl extends ServiceImpl<VoucherMapper, Voucher> implements IVoucherService {
    ...
    public Result queryVoucherOfShop(Long shopId) {
        // 查询优惠券信息
        List<Voucher> vouchers = queryVoucherEntitiesOfShop(shopId);
    ...
    public void addSeckillVoucher(Voucher voucher) {
        ...
        // Set TTL = activity end time + 7 days to prevent Redis memory leak
    ...
    @Override
    public List<Voucher> queryVoucherEntitiesOfShop(Long shopId) {
        if (shopId == null) {
    ...
    @Override
    public Voucher getVoucherEntityById(Long voucherId) {
